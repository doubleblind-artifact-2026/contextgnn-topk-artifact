...
class HeteroEncoder(torch.nn.Module):
    ...
    def __init__(
        ...
        for node_type in node_to_col_names_dict.keys():
            stype_encoder_dict = {
                stype: stype_encoder_cls_kwargs[stype][0](**stype_encoder_cls_kwargs[stype][1]) for stype in node_to_col_names_dict[node_type].keys()
            }
    ...
    def forward(
        ...
        x_dict = {
            node_type: self.encoders[node_type](tf.to(self.device))
